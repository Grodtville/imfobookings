      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-6">
            {/* Instagram */}
            <a
              href="http://www.instagram.com/imfobookings"
            ...
            {/* X (Twitter) */}
            <a
              href="http://www.twitter.com/imfobookings"
              className="hover:text-purple-300 transition"
            >
              <svg
                className="h-6 w-6"
            ...
            {/* Facebook */}
            <a
              href="http://www.facebook.com/imfobookings"
              className="hover:text-purple-300 transition"
            >
              <svg
                className="h-6 w-6"
            ...
            {/* LinkedIn */}
            <a
              href="http://www.linkedin.com/company/imfobookings"
              className="hover:text-purple-300 transition"
            >
              <svg
                className="h-6 w-6"
            ...
            {/* TikTok */}
            <a
              href="http://www.tiktok.com/@imfobookings"
              className="hover:text-purple-300 transition"
            >
              <svg
                className="h-6 w-6"
