...
import PackageCard from "@/components/PackageCard"; // Reuse your existing card (with modal trigger)
...
export default function SearchPage() {
  ...
  return (
    <>
      ...
      {/* Purple Footer — reuse from homepage */}
      <footer className="bg-purple-900 text-white py-12">
        {/* Your existing footer code with SVG socials */}
      </footer>
    </>
  );
}
