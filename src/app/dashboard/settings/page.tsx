        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              ...
              activity on the platform. Your photos, bookings, and messages will
              no longer be visible to others, but your data will be securely
              stored in case you decide to return.
            </p>
            <Button
              variant="destructive"
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              We recommend downloading any important receipts or payment records
              before continuing. If you're only taking a short break, consider
              deactivating your account instead.
            </p>
            <Button variant="destructive">Delete my account permanently</Button>
